...
class Letter(models.Model):
    ...
    top_background_color = models.CharField(max_length=7, default="#FFFFFF") 
    ...
    middle_background_color = models.CharField(max_length=7,default="#FFFFFF")  
    ...
    bottom_background_color = models.CharField(max_length=7, default="#FFFFFF") 
